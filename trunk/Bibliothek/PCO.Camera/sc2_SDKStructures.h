...
typedef struct
{
  ...
  DWORD       dwReservedDESC[6];       // 32bit dummy                             // 276
...
typedef struct
{
  ...
  WORD  ZZwAlignDummy1;
  char  strSignalName[4][25];          // Name of signal 104
...
typedef struct
{
  ...
  PCO_Signal  strSignal[NUM_MAX_SIGNALS];// Signal settings               // 1328
