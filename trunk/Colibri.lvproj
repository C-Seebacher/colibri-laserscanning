...
<Project Type="Project" LVVersion="8608001">
	...
	<Item Name="Mein Computer" Type="My Computer">
		...
		<Item Name="Configuration" Type="Folder">
			<Item Name="basicmenu.ini" Type="Document" URL="../Configuration/basicmenu.ini"/>
			<Item Name="fcsMic.ini" Type="Document" URL="../Configuration/fcsMic.ini"/>
			<Item Name="largemenu.ini" Type="Document" URL="../Configuration/largemenu.ini"/>
		...
		<Item Name="CoreApplication" Type="Folder" URL="../CoreApplication">
		...
		<Item Name="Plugins" Type="Folder">
			<Item Name="AnalyseTools" Type="Folder">
				<Item Name="AnalyseScanFromTIFF.vi" Type="VI" URL="../Plugins/AnalyseTools/AnalyseScanFromTIFF.vi"/>
				<Item Name="AnalyseScanFromTIFF_1.lvproj" Type="Document" URL="../Plugins/AnalyseTools/AnalyseScanFromTIFF_1.lvproj"/>
				<Item Name="FindPixelShift.vi" Type="VI" URL="../Plugins/AnalyseTools/FindPixelShift.vi"/>
				<Item Name="GalvoTestPanel.aliases" Type="Document" URL="../Plugins/AnalyseTools/GalvoTestPanel.aliases"/>
				<Item Name="GalvoTestPanel.lvproj" Type="Document" URL="../Plugins/AnalyseTools/GalvoTestPanel.lvproj"/>
				<Item Name="SelectPixelShift.vi" Type="VI" URL="../Plugins/AnalyseTools/SelectPixelShift.vi"/>
			</Item>
			<Item Name="AuxRecorder" Type="Folder"/>
			<Item Name="ElectricalStim" Type="Folder"/>
			<Item Name="FramePulser" Type="Folder"/>
			<Item Name="MouseSensor" Type="Folder"/>
			<Item Name="PockelsController" Type="Folder"/>
			<Item Name="POInavigator" Type="Folder"/>
			<Item Name="VisualStim" Type="Folder"/>
			<Item Name="OneKey.ahk" Type="Document" URL="../Plugins/OneKey.ahk"/>
		</Item>
		<Item Name="Abhängigkeiten" Type="Dependencies">
			...
			<Item Name="GaussTopfit.vi" Type="VI" URL="../Library/optional/GaussTopfit.vi"/>
			...
			<Item Name="pcoTDI.vi" Type="VI" URL="../GUI/Christian/TDI/pcoTDI.vi"/>
			<Item Name="CalculateStripes_StartEnd.vi" Type="VI" URL="../GUI/Christian/TDI/CalculateStripes_StartEnd.vi"/>
			...
			<Item Name="SC2_Cam.dll" Type="Document" URL="/pco.camera.sdk/1.01/sdk/pco.camera.sdk/bin/SC2_Cam.dll"/>
			<Item Name="ErrorManager.vi" Type="VI" URL="../Drivers/PCO.Camera/SW_DCLABVIEWWIN_107/Debug/ErrorManager.vi"/>
			<Item Name="SC2_Cam.dll" Type="Document" URL="../Drivers/PCO.Camera/SW_DCLABVIEWWIN_107/pco.camera.sdk/1.01/sdk/pco.camera.sdk/bin/SC2_Cam.dll"/>
			<Item Name="write16bitTiff_1Dversion.vi" Type="VI" URL="../Drivers/tiff/write16bitTiff_1Dversion.vi"/>
			<Item Name="Binningdll.dll" Type="Document" URL="../Drivers/ScanContinous/BinningDLL/Release/Binningdll.dll"/>
			<Item Name="Read1ofMultiTiff_withtext.vi" Type="VI" URL="../Bibliothek/tiff/Read1ofMultiTiff_withtext.vi"/>
			<Item Name="Odd.vi" Type="VI" URL="../Bibliothek/Odd.vi"/>
			<Item Name="IMAQ_RemoveBackground.vi" Type="VI" URL="../Outside/IMAQ_RemoveBackground.vi"/>
			<Item Name="IMAQ_Find-Peeks1.vi" Type="VI" URL="../Outside/IMAQ_Find-Peeks1.vi"/>
			<Item Name="SetImage.vi" Type="VI" URL="../Drivers/Bibliothek/iXon/SetImage.vi"/>
			<Item Name="IMIC_IsInit.vi" Type="VI" URL="../Drivers/TILLPhotonics/closeimic.vi/IMIC_IsInit.vi"/>
			<Item Name="IMIC_Close.vi" Type="VI" URL="../Drivers/TILLPhotonics/closeimic.vi/IMIC_Close.vi"/>
			<Item Name="ReadOffsetTiff_text_res.vi" Type="VI" URL="../Drivers/iXon/Spektrometer/ViewSpectralImage.vi/ReadOffsetTiff_text_res.vi"/>
